...
// Android minimal placeholders
#[cfg(feature = "android-minimal")]
mod android_placeholders {
    use std::collections::HashMap;
    
    pub fn peer_exists(_id: &str) -> bool { false }
    
    pub fn peer_to_map(_id: String, _p: crate::config::PeerConfig) -> HashMap<&'static str, String> {
        HashMap::new()
    }
