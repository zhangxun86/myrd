...
class RustdeskImpl {
  ...
  // Terminal 方法
  Future<void> sessionSendTerminalInput({required String sessionId, required String input}) => Future.value();
  Future<void> sessionResizeTerminal({required String sessionId, required int width, required int height}) => Future.value();
  Future<void> sessionOpenTerminal({required String sessionId, required int width, required int height}) => Future.value();
  Future<void> sessionCloseTerminal({required String sessionId}) => Future.value();

  // Plugin 方法
  Future<void> pluginEvent({required String id, required String event}) => Future.value();
  ...
  // 修复mainStoreFav参数类型为List<String>
