...
class __DisplayPageState extends State<_DisplayPage> {
        ...
        SettingsSection(
          tiles: [
            _getPopupDialogRadioEntry(
              ...
              getter: () =>
                  bind.mainGetUserDefaultOptionSync(key: kOptionViewStyle),
            ...
            _getPopupDialogRadioEntry(
              ...
              getter: () {
                final v =
                    bind.mainGetUserDefaultOptionSync(key: kOptionImageQuality);
            ...
            _getPopupDialogRadioEntry(
              ...
              list: codecList,
              getter: () =>
                  bind.mainGetUserDefaultOptionSync(key: kOptionCodecPreference),
  ...
  SettingsTile otherRow(String label, String key) {
    final value = bind.mainGetUserDefaultOptionSync(key: key) == 'Y';
