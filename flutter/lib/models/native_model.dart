...
class PlatformFFI {
  ...
  String translate(String name, String locale) =>
      _ffiBind.translate(name, locale);
  ...
  int getRgbaSize(SessionID sessionId, int display) =>
      _ffiBind.sessionGetRgbaSize(sessionId: sessionId.toString(), display: display);
  void nextRgba(SessionID sessionId, int display) {
      _ffiBind.sessionNextRgba(sessionId: sessionId.toString(), display: display);
  }
